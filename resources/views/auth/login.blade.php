...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md p-8 bg-white rounded-3xl border border-gray-100 shadow-sm">
        <div class="text-center mb-8">
            <div
                class="bg-blue-600 text-white w-12 h-12 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-200">
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email"
                    class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all">
            </div>
            <div>
            ...
            <button type="submit"
                class="w-full bg-blue-600 text-white font-semibold py-3 rounded-xl hover:bg-blue-700 transition-all shadow-md shadow-blue-100">
                Sign In
            </button>
        </form>
