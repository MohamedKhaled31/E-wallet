...
<body class="bg-white text-gray-900 font-sans">
    ...
    <nav class="flex flex-col md:flex-row justify-between items-center py-6 px-6 md:px-12 border-b border-gray-50 gap-4">
        <div class="flex items-center gap-2 font-bold text-2xl text-blue-600">
            <i class="fa-solid fa-wallet"></i> MyWallet
        </div>
        <div class="flex gap-4 md:gap-8 text-sm font-medium text-gray-600">
    ...
    <section id="home" class="text-center py-24 px-4">
        ...
        <h1 class="text-5xl md:text-7xl font-extrabold mt-8 mb-8 leading-[1.1]">Your Money.<br>Your Way.</h1>
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-6 md:gap-12 mt-16 text-gray-600">
            <div class="flex items-center justify-center gap-2"><i class="fa-solid fa-shield text-blue-500"></i> Bank-level Security
            </div>
            <div class="flex items-center justify-center gap-2"><i class="fa-solid fa-bolt text-blue-500"></i> Instant Transactions
            </div>
            <div class="flex items-center justify-center gap-2"><i class="fa-solid fa-headphones text-blue-500"></i> 24/7 Support</div>
        </div>
    </section>

    <section id="features" class="py-24 bg-gray-50 px-6 md:px-12">
    ...
    <section id="how-it-works" class="py-24 text-center px-4">
    ...
    <div class="flex flex-col md:flex-row justify-center items-center gap-8 px-4">
        ...
        <div class="flex flex-col items-center">
            <div class="w-20 h-20 bg-blue-50 text-blue-600 text-3xl rounded-3xl flex items-center justify-center mb-6 shadow-inner">
                <i class="fa-solid fa-user-plus"></i>
            </div>
            <p class="font-bold text-lg">Create Account</p>
        </div>

        <div class="text-gray-300 text-2xl mb-6 md:mb-0 md:-mt-14">
            <i class="fa-solid fa-arrow-down md:rotate-[-90deg]"></i>
        </div>

        <div class="flex flex-col items-center">
            <div class="w-20 h-20 bg-green-50 text-green-600 text-3xl rounded-3xl flex items-center justify-center mb-6 shadow-inner">
        ...
        <div class="flex flex-col items-center">
            <div class="w-20 h-20 bg-purple-50 text-purple-600 text-3xl rounded-3xl flex items-center justify-center mb-6 shadow-inner">
    ...
    <section id="security" class="py-12 px-6">
        <div class="bg-gray-900 rounded-3xl p-16 flex flex-col md:flex-row justify-between items-center text-white gap-8">
            <div>
    ...
    <footer class="bg-gray-50 py-16 px-6 md:px-12">
